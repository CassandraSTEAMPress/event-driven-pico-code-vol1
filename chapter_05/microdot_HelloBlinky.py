...
def webpage(time_local, temp_celsius, free_memory, led_state):
    ...
    <!doctype html>
    <html>
        <head><title>Hello, Blinky!</title></head>
        <body>
            <h1>Hello, Blinky!</h1>
            <form method="POST">
...
async def light_switch(request):
    ...
    # Turn LED light on if the client sent a POST request to turn
    #   on the LED
